...
class Rating_Markup extends Base {
	...
	public function classic_styling( $attributes ) {
		...
		$output .= '
            ...
            <ul class="srfm-classic-event srfm-rating-icon-wrapper mt-2 ml-0 mb-0 flex flex-wrap list-none gap-3 p-0 ">';
		for ( $i = 0; $i < $max_value; $i++ ) {
			$output .= '
                <li class="flex items-center flex-col-reverse" >
                <span class="srfm-text-primary">' . esc_html( strval( $show_numbers ? $i + 1 : '' ) ) . '</span>
                    <span
                    class="srfm-text-primary srfm-rating-icon cursor-pointer" data-value="' . esc_attr( strval( $i + 1 ) ) . '">
                    ' . $svg . ' 
                    </span>
                </li>';
		}
