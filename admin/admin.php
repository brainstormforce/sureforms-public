...
class Admin {
	...
	public function add_action_links( $links ) {
		if ( ! Helper::has_pro() ) {
			...
			$upsell_link = Helper::get_marketing_link( 'pricing', 'plugin-list' );
	...
	public function add_upgrade_to_pro() {
		...
		$upgrade_url = Helper::get_marketing_link( 'upgrade', 'submenu_link_upgrade' );
	...
	private function render_dashboard_widget_footer( $entries_data ) {
		...
		if ( $total_entries >= 3 || $published_forms_count >= 3 ) {
			...
			<div class="srfm-widget-footer">
				...
				<?php
					$upgrade_url = Helper::get_marketing_link( 'pricing', 'dashboard-widget' );
				?>
