...
class SF_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( SUREFORMS_SLUG . '-frontend-default', $css_uri . '/blocks/default/frontend' . $file_prefix . '.css', [], SUREFORMS_VER );
		...
		if ( is_single() ) {
			wp_enqueue_style( SUREFORMS_SLUG . '-single', $css_uri . 'single' . $file_prefix . '.css', [], SUREFORMS_VER );
		}
