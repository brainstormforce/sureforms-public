...
use SureForms\Inc\SureForms_Number_Field_Markup;
	...
	public function render( $attributes, $content = '' ) {
		if ( ! empty( $attributes ) ) {
			...
			switch ( $styling ) {
				case 'inherit':
					// phpcs:ignore
					echo SureForms_Number_Field_Markup::number_field_default_styling( $attributes );
					break;
				case 'classic':
					// phpcs:ignore
					echo SureForms_Number_Field_Markup::number_field_classic_styling( $attributes );
					break;
				default:
					// phpcs:ignore
					echo SureForms_Number_Field_Markup::number_field_default_styling( $attributes );
