...
let iconCommonData = {};
iconCommonData = applyFilters( 'sureforms/icon', addCommonDataToSpectraBlocks( iconCommonData ) );
registerBlockType( 'sureforms/icon', {
	...iconCommonData,
	apiVersion: 2,
	title: __( 'Icon', 'sureforms' ),
	description: __( 'Add stunning customizable icons to your website.', 'sureforms' ),
