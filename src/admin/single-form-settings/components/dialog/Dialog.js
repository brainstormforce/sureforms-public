...
const Dialog = ( {
	...
	const [ pluginConnected, setPluginConnected ] = useState( srfm_admin?.integrations?.sure_triggers?.connected ?? null );
	...
	const tabs = applyFilters(
		...
		[
			...
			},
			{
				...
				component: (
					<OttoKitPage
						{ ...{ isFormSettings: true, setSelectedTab, pluginConnected, setPluginConnected } }
					/>
				),
			},
			{
