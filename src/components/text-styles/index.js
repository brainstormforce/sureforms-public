	...
	const popUpActionWrapper = () => {
		return (
			<div className="srfm-control-popup__options--action-wrapper">
				...
				>
					<svg width="28" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M0.605578 6.89308L0.0147844 9.44812C-0.00559594 9.54152 -0.00489729 9.6383 0.0168293 9.7314C0.0385559 9.82449 0.0807616 9.91155 0.140363 9.98621C0.199965 10.0609 0.275457 10.1212 0.361324 10.1629C0.447191 10.2046 0.541265 10.2265 0.636672 10.2271C0.681128 10.2316 0.725923 10.2316 0.770378 10.2271L3.33567 9.63507L8.26102 4.71818L5.51227 1.96995L0.605578 6.89308Z" fill="#555D66"/>
						<path d="M9.80952 2.25661L7.97495 0.418229C7.85433 0.297975 7.69111 0.230469 7.52097 0.230469C7.35083 0.230469 7.18761 0.297975 7.06699 0.418229L6.0471 1.44025L8.79273 4.19159L9.81263 3.16957C9.87231 3.10946 9.91958 3.03814 9.95173 2.9597C9.98388 2.88127 10.0003 2.79724 10 2.71245C9.99971 2.62765 9.98274 2.54374 9.95005 2.46552C9.91737 2.38731 9.86961 2.31631 9.80952 2.25661Z" fill="#555D66"/>
					</svg>
				</Button>
			</div>
		);
