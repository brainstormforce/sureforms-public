...
export const SliderClassicStyle = ( { attributes, blockID } ) => {
						...
						<div className="range-slider-group range-slider-group-sf">
							...
							<div className="flex justify-between items-center">
								<input
									...
									step={ step }
									value={ slideValue }
                                    style={ { background:`linear-gradient(to right, rgb(2, 132, 199) 0%, rgb(2, 132, 199) ${bgValue}%, rgb(255, 255, 255) ${bgValue}%, white 100%)` } }
								...
								<input
									...
									max={ parseInt( max ) }
									value={ slideValue }
									className="input-slider number-input-slider-sf !w-[60px] !border-solid !border-[1px] !border-[#D1D5DB] !rounded-md !px-2 !py-1 !text-center !bg-white focus:!border-sf_primary_color focus:!ring-sf_primary_color focus:!outline-0 focus:!bg-white sm:text-sm sm:leading-6"
								/>
							</div>
						</div>
					</div>
