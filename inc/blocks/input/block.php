...
class Block extends Base {
	...
	public function render( $attributes, $content = '' ) {
		...
		<div class="sureforms-input-text-container main-container" style="display:flex; flex-direction:column; gap:0.5rem;">
			...
			<input id="sureforms-input-text" name="<?php echo esc_attr( str_replace( ' ', '_', $label . 'SF-divider' . $id ) ); ?>" type="text" <?php echo esc_attr( $required ? 'required' : '' ); ?> value="<?php echo esc_attr( $default ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" 
