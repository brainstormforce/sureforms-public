...
<?php
		...
		$classname                 = $sureforms_form_class_name ? strval( $sureforms_form_class_name ) : '';
...
<div id="sforms-single-form-page">
	...
	<div>
		<form method="post" id="sureforms-form-<?php echo esc_attr( $custom_post_id ); ?>" class="sureforms-form sureforms-single-form <?php echo esc_attr( $classname ); ?> <?php echo esc_attr( '' !== $background_image_url ? 'sureforms-form-background' : '' ); ?>" 
