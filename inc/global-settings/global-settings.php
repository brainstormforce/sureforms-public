...
class Global_Settings {
	...
	public static function srfm_save_security_settings( $setting_options ) {
		...
		$srfm_hcaptcha_site_key       = isset( $setting_options['srfm_hcaptcha_site_key'] ) ? $setting_options['srfm_hcaptcha_site_key'] : '';
		$srfm_hcaptcha_secret_key     = isset( $setting_options['srfm_hcaptcha_secret_key'] ) ? $setting_options['srfm_hcaptcha_secret_key'] : '';
