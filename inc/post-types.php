	...
	public function register_post_metas() {
		...
		$metas = apply_filters(
			...
			[
				...
				// Page Break Button.
				'_srfm_page_break_button_bg_color'      => 'string',
				'_srfm_page_break_button_text_color'    => 'string',
				'_srfm_page_break_button_border_color'  => 'string',
				'_srfm_page_break_button_border_width'  => 'integer',
				'_srfm_page_break_button_border_radius' => 'integer',
				'_srfm_page_break_inherit_theme_button' => 'boolean',
				'_srfm_page_break_button_bg_type'       => 'string',
				// Additional Classes.
