...
export default function styling(
	...
	if ( maskShape !== 'none' ) {
		...
		if ( typeof imagePath !== 'undefined' && imagePath ) {
			selectors[
				`.wp-block-uagb-image .wp-block-uagb-image__figure img, .uagb-block-${ block_id } .wp-block-uagb-image--layout-overlay__color-wrapper`
			] = {
	...
	tablet_selectors[ '.wp-block-uagb-image--layout-default figure img' ] =
		imageBorderCSSTablet;
	tablet_selectors[ '.wp-block-uagb-image--layout-overlay figure img' ] =
		imageBorderCSSTablet;
	...
	mobile_selectors[ '.wp-block-uagb-image--layout-default figure img' ] =
		imageBorderCSSMobile;
	mobile_selectors[ '.wp-block-uagb-image--layout-overlay figure img' ] =
		imageBorderCSSMobile;
	...
	const base_selector = gbsSelector
		...
		: `.editor-styles-wrapper .uagb-block-${ block_id }`;
