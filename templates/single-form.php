	...
	?>
		<style>
			...
			.single-sureforms_form .srfm-single-page-container .srfm-page-banner {
				<?php if (!empty($srfm_cover_image_url)) : ?>background-image: url(<?php echo esc_attr($srfm_cover_image_url); ?> );
				background-position: center;
				background-size: cover;
				background-repeat: no-repeat;
				<?php else : ?>background-color: <?php echo esc_attr($srfm_color_primary); ?>;
				<?php endif; ?>
			}
		</style>
