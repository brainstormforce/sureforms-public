...
class Block extends Base {
	...
	public function render( $attributes, $content = '' ) {
		...
		<div class="sureforms-input-number-container main-container sf-classic-inputs-holder  <?php echo esc_attr( $classname ); ?>">
			...
			<div class="mt-2">
				<input type="<?php echo 'none' === $format_type ? 'number' : 'text'; ?>" name="<?php echo esc_attr( str_replace( ' ', '_', $label . 'SF-divider' . $id ) ); ?>" id="sureforms-input-number-<?php echo esc_attr( $id ); ?>" class="block !w-full !border-solid !border-0 !border-[#d1d5db] !rounded-md !py-1.5 !text-gray-900 !shadow-sm !ring-1 !ring-inset  !ring-gray-300 !bg-white placeholder:!text-gray-500 focus:!ring-2 focus:!border-solid focus:!border-primary_color focus:!ring-primary_color focus:!outline-0 focus:!bg-white sm:text-sm sm:leading-6" 
