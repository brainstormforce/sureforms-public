 ...
 * @since 0.0.1
 */
class SRFM_Input_Markup extends Base {
	...
	public function markup( $attributes, $form_id ) {
		...
		$duplicate_msg = isset( $attributes['duplicateMsg'] ) && $attributes['duplicateMsg'] ? $attributes['duplicateMsg'] : SRFM_Helper::get_default_dynamic_block_option( 'srfm_input_block_unique_text' );
		$placeholder   = isset( $attributes['placeholder'] ) ? $attributes['placeholder'] : '';
		$label         = isset( $attributes['label'] ) ? $attributes['label'] : '';
		$field_width   = isset( $attributes['fieldWidth'] ) ? $attributes['fieldWidth'] : '';
		$help          = isset( $attributes['help'] ) ? $attributes['help'] : '';
		$error_msg     = isset( $attributes['errorMsg'] ) && $attributes['errorMsg'] ? $attributes['errorMsg'] : SRFM_Helper::get_default_dynamic_block_option( 'srfm_input_block_required_text' );
