...
namespace SRFM\Inc\Database {
    ...
    abstract class Base
    {
         ...
         */
        public abstract function get_schema();
        /**
         ...
         * @return array<string>
         */
        public abstract function get_columns_definition();
        /**
...
namespace SRFM\Inc\Database\Tables {
     ...
     * @since 0.0.10
     */
    class Entries extends \SRFM\Inc\Database\Base
    {
        use \SRFM\Inc\Traits\Get_Instance;
        /**
         * {@inheritDoc}
...
namespace SRFM\Inc {
    ...
    class Frontend_Assets
    {
         ...
         * @var array<string>
         */
        public static $js_assets = ['form-submit' => 'formSubmit', 'frontend' => 'frontend'];
        /**
         * CSS Assets.
         *
         * @since 0.0.11
         * @var array<string>
         */
        public static $css_assets = ['frontend-default' => 'blocks/default/frontend', 'common' => 'common', 'form' => 'frontend/form', 'single' => 'single'];
        /**
         * External CSS Assets.
         *
         * @since 0.0.11
         * @var array<string>
         */
        public static $css_external_assets = ['tom-select' => 'tom-select', 'intl-tel-input' => 'intl/intlTelInput.min'];
        /**
         * Constructor
         *
         * @since  0.0.1
...
namespace SRFM\Inc {
    ...
    class Export
    {
         ...
         * @var array<string>
         */
        public $unserialized_post_metas = ['_srfm_conditional_logic', '_srfm_email_notification', '_srfm_form_confirmation', '_srfm_compliance', '_srfm_forms_styling', '_srfm_integrations_webhooks', '_srfm_instant_form_settings', '_srfm_page_break_settings'];
        /**
         * Constructor
         *
         * @since  0.0.1
...
namespace {
    ...
    \define('SRFM_PRO_RECOMMENDED_VER', '1.0.5');
