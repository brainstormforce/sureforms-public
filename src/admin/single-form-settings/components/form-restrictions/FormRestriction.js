		...
		>
			...
			<Container direction="column" className="gap-6">
				<Switch
					size="sm"
					label={ {
						heading: __( 'Enable Form Scheduling', 'sureforms' ),
						description: __(
					...
					<>
							...
							<div className="w-2/3">
								<DatePickerModal
									...
									onDateChange={ ( formattedDate ) => {
										updateMeta( 'startDate', formattedDate );
									} }
								/>
							</div>
							...
							{ preserveMetaData?.startDate && (
								<div className="w-1/3">
									<TimePicker
										...
										onChange={ ( key, value ) => {
											if ( key === 'hours' ) {
												updateMeta( 'startHours', value );
											} else if ( key === 'minutes' ) {
												updateMeta( 'startMinutes', value );
											} else if ( key === 'meridiem' ) {
												updateMeta( 'startMeridiem', value );
											}
										} }
									/>
								</div>
						...
						<div>
							...
							<TextArea
								...
								onChange={ ( value ) => {
									updateMeta( 'schedulingNotStartedMessage', value );
								} }
							/>
						</div>
						...
						<div>
							...
							<TextArea
								...
								onChange={ ( value ) => {
									updateMeta( 'schedulingEndedMessage', value );
								} }
							/>
						</div>
					</>
