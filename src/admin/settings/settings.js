...
const Settings = () => {
	...
	return (
		<>
			<Router>
				<FormPageHeader />
				<div className="grid grid-cols-[14rem_1fr] auto-rows-fr bg-background-secondary before:content-['_'] before:fixed before:inset-0 before:h-full before:w-[16rem] before:bg-background-primary before:shadow-sm">
					<Navigation />
