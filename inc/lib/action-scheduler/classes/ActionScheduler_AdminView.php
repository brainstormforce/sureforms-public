...
class ActionScheduler_AdminView extends ActionScheduler_AdminView_Deprecated {
	...
	protected function check_pastdue_actions() {
		...
		/* translators: 1) number of affected actions, 2) link to admin screen */
		printf(
			_n(
	...
	public function add_help_tabs() {
		...
		$screen->add_help_tab(
			array(
				...
				'content' =>
					'<h2>' . /* translators: %s: version number */ sprintf( __( 'About Action Scheduler %s', 'action-scheduler' ), $as_version ) . '</h2>' .
					'<p>' .
